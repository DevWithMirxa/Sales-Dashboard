    ...
    <DashboardLayout>
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-2">Submit data to the backend system.</p>
        </div>
        <button onClick={logout} className="text-red-500 hover:underline text-sm font-semibold">Logout</button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-gray-500 text-sm">Add or edit customers in the system.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 text-sm">Add or manage sales representatives.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 text-sm">Manage sales regions and territories.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 text-sm">Add new products and manage inventory items.</p>
        </div>
      </div>
